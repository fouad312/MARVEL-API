...
class Data {
  ...
  int? total;
  int? count;
  List<ResultsCharacter>? resultsCharacter;

  Data({this.offset, this.limit, this.total, this.count, this.resultsCharacter});
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['results'] != null) {
      resultsCharacter = <ResultsCharacter>[];
      json['results'].forEach((v) {
        resultsCharacter!.add(ResultsCharacter.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (resultsCharacter != null) {
      data['results'] = resultsCharacter!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class EventsItems {
  ...
  EventsItems({this.resourceURI, this.name});
